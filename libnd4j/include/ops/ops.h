...
#define no_op_exec_special_any     static const bool requiresSpecial = false; static void execSpecial(const X *dx, const sd::LongType *xShapeBuffer, Z *result, const sd::LongType *resultShapeBuffer, X *extraParams, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_bool     static const bool requiresSpecial = false; static void execSpecial(const X *dx, const sd::LongType *xShapeBuffer, Z *result, const sd::LongType *resultShapeBuffer, X *extraParams, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_same     static const bool requiresSpecial = false; static void execSpecial(const X *dx, const sd::LongType *xShapeBuffer, X *result, const sd::LongType *resultShapeBuffer, X *extraParams, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special     static const bool requiresSpecial = false; static void execSpecial(const X *dx, const sd::LongType *xShapeBuffer, Z *result, const sd::LongType *resultShapeBuffer, Z *extraParams, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_accumulation     static const bool requiresSpecialAccumulation = false; static void execSpecial(const X *x, const sd::LongType *xShapeInfo, Z *extraParams, Z *result, const sd::LongType *resultShapeInfoBuffer, int *dimension, int dimensionLength, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffset){}
#define no_op_exec_special_accumulation_long     static const bool requiresSpecialAccumulation = false; static void execSpecial(const X *x, const sd::LongType *xShapeInfo, X *extraParams, Z *result, const sd::LongType *resultShapeInfoBuffer, int *dimension, int dimensionLength, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffset){}
#define no_op_exec_special_accumulation_same     static const bool requiresSpecialAccumulation = false; static void execSpecial(const X *x, const sd::LongType *xShapeInfo, X *extraParams, X *result, const sd::LongType *resultShapeInfoBuffer, int *dimension, int dimensionLength, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffset){}
#ifdef __CUDACC__
#define no_op_exec_special_any_cuda static SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeBuffer, Z *result, const sd::LongType *resultShapeBuffer, X *extraParams, int *allocationPointer, Z *reductionPointer, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_bool_cuda static SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeBuffer, Z *result, const sd::LongType *resultShapeBuffer, X *extraParams, int *allocationPointer, Z *reductionPointer, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_same_cuda static SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeBuffer, X *result, const sd::LongType *resultShapeBuffer, X *extraParams, int *allocationPointer, X *reductionPointer, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_cuda static SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeBuffer,Z *result, const sd::LongType *resultShapeBuffer,Z *extraParams, int *allocationPointer, Z *reductionPointer, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_accumulation_same_cuda static SD_INLINE SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeInfo, X *extraParams, X *result, const sd::LongType *resultShapeInfo, int *dimension, int dimensionLength, X *reductionBuffer, const sd::LongType *tadOnlyShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_accumulation_long_cuda static SD_INLINE SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeInfo, X *extraParams, Z *result, const sd::LongType *resultShapeInfo, int *dimension, int dimensionLength, Z *reductionBuffer, const sd::LongType *tadOnlyShapeInfo, const sd::LongType *tadOffsets) {}
#define no_op_exec_special_accumulation_cuda static SD_INLINE SD_DEVICE void execSpecialCuda(const X *dx, const sd::LongType *xShapeInfo, Z *extraParams, Z *result, const sd::LongType *resultShapeInfo, int *dimension, int dimensionLength, Z *reductionBuffer, const sd::LongType *tadOnlyShapeInfo, const sd::LongType *tadOffsets) {}
...
namespace simdOps {
    ...
    public:
        ...
        SD_OP_DEF static X startingValue() {
    ...
    class NewAdd {
    public:
        SD_OP_DEF static X op(X d1, Y d2, X *params) {
            return d1 + d2;
        }
    };
    ...
    public:
        SD_OP_DEF static Z op(X z, Y c) {
            ...
            return (sd::math::sd_exp<Y, Z>(c) - zz * zc  + (zz * sd::math::sd_log<X, Z>(z) - zz + static_cast<Z>(0.5f) * sd::math::sd_log<Z, Z>(static_cast<Z>(DOUBLE_PI_X) * zz)));
        }
        ...
        SD_OP_DEF static Z op(X z) {
            auto zz = static_cast<Z>(z);
            return (zz * sd::math::sd_log<Y, Z>(z) - zz + static_cast<Z>(0.5f) * sd::math::sd_log<Z, Z>(static_cast<Z>(DOUBLE_PI_X) * zz));
        }

        // op for MetaOps
        SD_OP_DEF static X op(X z, Y *params) {
            return (sd::math::sd_exp<X, X>(params[0]) - z * params[0]  + (z * sd::math::sd_log<X, Z>(z) - z + static_cast<X>(0.5f) * sd::math::sd_log<X, Z>(DOUBLE_PI_X * z)));
        }
    };
    ...
    public:
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_floor<Z,Z>(static_cast<Z>(d1 / d2));
        }
        ...
        SD_OP_DEF static Z op(X d1) {
            return sd::math::sd_floor<Z,Z>(static_cast<Z>(d1));
        }

        // op for MetaOps
        SD_OP_DEF static Z op(X d1, Y *params) {
            return sd::math::sd_floor<Z,Z>(static_cast<Z>(d1 / params[0]));
        }
    };
    ...
    public:
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_remainder<X, Y, Z>(d1, d2);
        }
        ...
        // op for MetaOps
        SD_OP_DEF static Z op(X d1, Y *params) {
            return sd::math::sd_remainder<X, Y, Z>(d1, params[0]);
        }
    };
    ...
    public:
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_fmod<X, Y, Z>(d1, d2);
        }
        ...
        // op for MetaOps
        SD_OP_DEF static Z op(X d1, Y *params) {
            return sd::math::sd_fmod<X, Y, Z>(d1, params[0]);
        }
    };
    ...
    public:
        SD_OP_DEF static Z op(X d1, Y d2) {
            ...
            return (d1 < static_cast<X>(0)) == (d2 < static_cast<Y>(0)) ? m : sd::math::sd_fmod<Z, Y, Z>(m + static_cast<Z>(d2), d2);
        }

        SD_OP_DEF static Z op(X d1, Y d2, Z *params) {
            auto m = sd::math::sd_fmod<X, Y, Z>(d1, d2);
            return (d1 < static_cast<X>(0.0f)) == (d2 < static_cast<Y>(0)) ? m : sd::math::sd_fmod<Z, Y, Z>(m + static_cast<Z>(d2), d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X d2) {
            return d2 | d1;
        }
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X d2) {
            return sd::math::sd_rotl<X>(d1, d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X d2) {
            return sd::math::sd_rotr<X>(d1, d2);
        }
    ...
    */
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, Y d2, Z *params) {
            return sd::math::sd_log<X, Z>(d1) / sd::math::sd_log<Y, Z>(d2) ;
        }
    };
...
//        }
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, Z *params) {
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, X *params) {
            ...
            return sd::math::sd_re<X>(d1, d2) > thresholdRelative ? (sd::math::sd_abs<X>(d1 - static_cast<X>(d2)) < thresholdAbsolute ? static_cast<Z>(0) : static_cast<Z>(1)) : static_cast<Z>(0);
         }
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_pow<X, Y, Z>(d2, d1);
        }
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_pow<X, Y, Z>(d1, d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_igamma<X, Y, Z>(d1, d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static Z op(X d1, Y d2) {
            return sd::math::sd_igammac<X, Y, Z>(d1, d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static X startingValue(const X *input) {
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            ...
            return (ex * (4 * (d1 + 1) + 4 * e2x + e3x + ex *(4 * d1 + 6))) / sd::math::sd_pow<X, X, X>((2 * ex + e2x + 2), (X) 2.f);
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            ...
            return (ex * (d1 + ex + static_cast<X>(1.f))) / sd::math::sd_pow<X, X, X>((ex + static_cast<X>(1.f)) , static_cast<X>(2.f));
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            return sd::math::sd_min<X>(static_cast<X>(1), sd::math::sd_max<X>(static_cast<X>(0), (static_cast<X>(0.2f)) * d1 + static_cast<X>(0.5f)));
        }
    };
    ...
    */
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            ...
            auto tanh = sd::math::sd_sgn<X,X>(dis) * (static_cast<X>(1) - (static_cast<X>(1) / (static_cast<X>(1) + static_cast<X>(sd::math::sd_abs<X>(dis)) + sd::math::sd_pow<X, X, X>(dis, static_cast<X>(2)) + static_cast<X>(1.41645f) * sd::math::sd_pow<X, X, X>(dis, static_cast<X>(4)) )));
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            ...
            auto a = static_cast<X>(1.f) + sd::math::sd_abs<X>(dis) + sd::math::sd_pow<X, X, X>(dis, static_cast<X>(2.f)) + static_cast<X>(1.41645f) * sd::math::sd_pow<X, X, X>(dis, static_cast<X>(4));

            auto tDeriv = (static_cast<X>(1.f) + sd::math::sd_sign<X,X>(dis) * (static_cast<X>(2.f) * dis + static_cast<X>(4.f) * static_cast<X>(1.41645f) * sd::math::sd_pow<X, X, X>(dis, static_cast<X>(3)))) / (a * a);
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            return static_cast<X>(1.f) / (sd::math::sd_sqrt<X, X>(sd::math::sd_pow<X, X, X>(d1, static_cast<X>(2.f)) + static_cast<X>(1.f)));
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            return static_cast<X>(1.f) / (sd::math::sd_sqrt<X, X>(d1 - static_cast<X>(1.f)) * sd::math::sd_sqrt<X, X>(d1 + static_cast<X>(1.f)));
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static Z merge(Z old, Z opOutput, X *extraParams) {
            return old + opOutput;
        }

        SD_OP_DEF static Z update(Z old, Z opOutput, X *extraParams) {
            return old + opOutput;
        }
        ...
        SD_OP_DEF static Z postProcess(Z reduction, sd::LongType n, X *extraParams) {
            return reduction;
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            return d1 > static_cast<X>(0.0f) ? static_cast<X>(SELU_LAMBDA) * static_cast<X>(d1) : static_cast<X>(SELU_LAMBDA) * (static_cast<X>(SELU_ALPHA) * sd::math::sd_exp<X, X>(d1) - static_cast<X>(SELU_ALPHA));
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X *params) {
            return d1 > static_cast<X>(0.f) ? static_cast<X>(SELU_LAMBDA) : static_cast<X>(SELU_ALPHA) * static_cast<X>(SELU_LAMBDA) * sd::math::sd_exp<X, X>(d1);
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static X postProcess(X reduction, sd::LongType n, X *extraParams) {
            return reduction;
        }
    };
    ...
    */
    ...
    public:
        ...
        SD_OP_DEF static X postProcess(X reduction, sd::LongType n, X *extraParams) {
            return sd::math::sd_abs<X>(reduction);
        }
    };
    ...
    public:
        ...
        SD_OP_DEF static InterType merge(InterType old, InterType opOutput, X *extraParams) {
            return opOutput + old;
        }

        SD_OP_DEF static InterType update(InterType old, InterType opOutput, X *extraParams) {
            return opOutput + old;
        }
    ...
    public:
        ...
        SD_OP_DEF static InterType op(X d1, Z *extraParams) {
            auto f1 = static_cast<float>(d1);
            return static_cast<InterType>(sd::math::sd_pow<float,float,float>(f1, 3)
                    + sd::math::sd_log<float,float>(f1) * sd::math::sd_sin<float,float>(f1)
                    / sd::math::sd_tanh<float,float>(static_cast<float>(M_E) * static_cast<float>(M_PI) * f1)
                    * sd::math::sd_sqrt<float,float>(static_cast<float>(M_PI) / f1)
                    - sd::math::sd_atan<float,float>(static_cast<float>(M_E) / f1));
    ...
    public:
        ...
        SD_OP_DEF static InterType op(X d1, Z *extraParams) {
            return sd::math::sd_abs<InterType>(d1);
        }
    ...
    public:
        ...
        SD_OP_DEF static X merge(X old, X opOutput, X *extraParams) {
            return sd::math::sd_max<X>(old, opOutput);
        }

        SD_OP_DEF static X update(X old, X opOutput, X *extraParams) {
            return sd::math::sd_max<X>(opOutput, old);
        }

        SD_OP_DEF static X op(X d1, X d2, X *params) {
            return sd::math::sd_max<X>(d1, d2);
        }
    ...
    public:
        SD_OP_DEF static Z op(X d1, Y d2, Z *params) {
            return sd::math::sd_max<Z>(static_cast<Z>(d1), static_cast<Z>(d2));
        }
    ...
    public:
        SD_OP_DEF static Z op(X d1, Y d2, Z *params) {
            return sd::math::sd_min<Z>(static_cast<Z>(d1), static_cast<Z>(d2));
        }
    ...
    public:
        ...
        SD_OP_DEF static X op(X d1, X d2) {
            return sd::math::sd_abs<X>(d1) > sd::math::sd_abs<X>(d2) ? d1 : d2;
        }
    ...
    public:
        ...
        SD_OP_DEF static X merge(X old, X opOutput, X *extraParams) {
            return sd::math::sd_min<X>(old, opOutput);
        }

        SD_OP_DEF static X update(X old, X opOutput, X *extraParams) {
            return sd::math::sd_min<X>(opOutput, old);
        }

        SD_OP_DEF static X op(X d1, X d2, X *params) {
            return sd::math::sd_min<X>(d1, d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static InterType op(X d1, Z *extraParams) {
            return static_cast<InterType>(sd::math::sd_abs<X>(d1));
        }
    ...
    public:
        ...
        SD_OP_DEF static Z merge(Z old, Z opOutput, Z *extraParams) {
            return opOutput + old;

        }

        SD_OP_DEF static Z update(Z old, Z opOutput, Z *extraParams) {
            return sd::math::sd_max<Z>(sd::math::sd_abs<Z>(old),
                sd::math::sd_abs<Z>(opOutput));
        }

        SD_OP_DEF static Z op(X d1, Z *extraParams) {
            return static_cast<Z>(d1);
        }
    ...
    */
    ...
    public:
        ...
        SD_OP_DEF static Y startingValue(const X *input) {
        ...
        SD_OP_DEF static Y update(Y old, Y opOutput, Y *extraParams) {
            return old + opOutput;
        }


        SD_OP_DEF static Y merge(Y old, Y opOutput, Y *extraParams) {
    ...
    public:
        ...
        SD_OP_DEF static Y num(X d1, X d2) {
            return sd::math::sd_min<X>(d1, d2);
        }

        SD_OP_DEF static Y denom(X d1, X d2) {
            return sd::math::sd_max<X>(d1, d2);
        }
    ...
    public:
        ...
        SD_OP_DEF static Y postProcess(Y reduction, sd::LongType n, Y *extraParams) {
            return (static_cast<Y>(1.0f)) - (reduction / (sd::math::sd_sqrt<Y, Y>(extraParams[0]) * sd::math::sd_sqrt<Y, Y>(extraParams[1])));
        }
    ...
    */
    ...
    public:
        ...
        SD_OP_DEF static Y update(Y old, Y opOutput, Y *extraParamsRef) {
            return opOutput + old;
        }

        SD_OP_DEF static Y merge(Y old, Y opOutput, Y *extraParamsRef) {
    ...
    */
    ...
    public:
        ...
        SD_OP_DEF static Z merge(X old, Z opOutput, Z *extraParamsRef) {
            return update(old, opOutput, extraParamsRef);
        }
    ...
    public:
        ...
        SD_OP_DEF static Y merge(X old, X opOutput, X *extraParamsRef) {
            return update(old, opOutput, extraParamsRef);
        }
    };
    ...
    public:
        static SD_HOST_DEVICE inline functions::indexreduce::IndexValue<X> op(functions::indexreduce::IndexValue<X> val, X *extraParams) {
            return sd::math::sd_abs<X>(val);
        }

        static SD_HOST_DEVICE inline functions::indexreduce::IndexValue<X> update(functions::indexreduce::IndexValue<X> &old, functions::indexreduce::IndexValue<X> &opOutput, X *extraParams) {
        ...
        functions::indexreduce::IndexValue<X> f2, X *extraParams) {
            if (sd::math::sd_abs<X>(f1.value) > sd::math::sd_abs<X>(f2.value))
                return f2;
            return f1;
        }
        ...
        static SD_HOST_DEVICE inline X startingValue(const X *input) {
            return 0;
        }
    ...
    public:
        ...
        static SD_HOST_DEVICE  functions::indexreduce::IndexValue<X> update(functions::indexreduce::IndexValue<X> &old, functions::indexreduce::IndexValue<X> &opOutput, X *extraParams) {
    ...
    public:
        ...
        static SD_HOST_DEVICE inline functions::summarystats::SummaryStatsData<X> op(functions::summarystats::SummaryStatsData<X> d1, Z *extraParams) {
            return d1;
        }
    };
    ...
    public:
        ...
        inline SD_DEVICE static X op(X d1, X *params) {
            ...
            X rnd = sd::math::sd_abs<X>(sd::math::sd_cos<X>(static_cast<X>(clock64()) * static_cast<X>(tid) + static_cast<X>(length) * static_cast<X>(tid)));
#else
