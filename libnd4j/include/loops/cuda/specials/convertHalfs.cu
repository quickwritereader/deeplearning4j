...
///////////////////////////////////////////////////////////////////////
    ...
    BUILD_SINGLE_TEMPLATE(template void SD_LIB_HIDDEN convertHalfsToGeneric, (dim3 & launchDims, cudaStream_t * stream, half * dx, sd::LongType n, void * dz), SD_COMMON_TYPES);
}