...
SD_LIB_HIDDEN void gruCell(sd::LaunchContext * context, const NDArray* x, const NDArray* hLast, const NDArray* Wru, const NDArray* Wc,
                 const NDArray* bru, const NDArray* bc,
                 NDArray* r, NDArray* u, NDArray* c, NDArray* h);

SD_LIB_HIDDEN void gruCell(sd::LaunchContext * context, const NDArray* x, const NDArray* hLast, const NDArray* Wru, const NDArray* Wc, const NDArray* b,
                 NDArray* gates, NDArray* h);

SD_LIB_HIDDEN void gruTimeLoop(sd::LaunchContext * context, const NDArray* x, const NDArray* h0, const NDArray* Wx, const NDArray* Wh, const NDArray* b, NDArray* h);

SD_LIB_HIDDEN void gruCellBp(sd::LaunchContext* context,
...
SD_LIB_HIDDEN void gruTimeLoopBp(sd::LaunchContext * context,
