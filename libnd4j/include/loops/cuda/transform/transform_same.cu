...
SD_KERNEL void transformSameSimple(const void *x, const sd::LongType *xShapeInfo, int xRank,
                                void *params,
...
namespace functions {
    namespace transform {
        ...
        template<typename X>
        SD_HOST void TransformSame<X>::executeTransformShaped(dim3 launchDims, cudaStream_t *stream,
                                                              const int opNum,
        ...
        SD_DEVICE void TransformSame<X>::transformCuda(const void *vx, const sd::LongType *xShapeInfo,
                                                        void *vparams,
        ...
        template<typename X>
        template <typename OpType>
        SD_HOST void TransformSame<X>::intermediateShaped(dim3 launchDims, cudaStream_t *stream, const void *x, const sd::LongType *xShape, int xRank, void *extraParams, void *z, const sd::LongType *zShape, int zRank, int *allocationPointer, void *reductionPointer,  const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {
