...
///////////////////////////////////////////////////////////////////
template<typename T>
SD_KERNEL void amsGradUpdaterCuda(const void* vx, const sd::LongType* xShapeInfo, const void* vinv, const sd::LongType* invShapeInfo, 
                                  const void* vinm, const sd::LongType* inmShapeInfo, const void* vinh, const sd::LongType* inhShapeInfo,
                                  void* vz, const sd::LongType* zShapeInfo,  void* vstV, const sd::LongType* stvShapeInfo, void* vstM, 
                                  const sd::LongType* stmShapeInfo, void* vstH, const sd::LongType* sthShapeInfo,
    ...
    if (threadIdx.x == 0) {
        ...
        epsilonT = lr * sd::math::sd_sqrt<T, T>(1.0 - sd::math::sd_pow<T, T, T>(beta2, (iteration + 1))) / (1.0 - sd::math::sd_pow<T, T, T>(beta1, (iteration + 1)));
...
///////////////////////////////////////////////////////////////////
template<typename T>
void amsGradUpdaterCudaLauncher(const int blocksPerGrid, const int threadsPerBlock, const cudaStream_t* stream, const void* vx, const sd::LongType* xShapeInfo,
    const void* vinv, const sd::LongType* invShapeInfo, const void* vinm, const sd::LongType* inmShapeInfo,
    const void* vinh, const sd::LongType* inhShapeInfo,  void* vz, const sd::LongType* zShapeInfo,
    void* vstV, const sd::LongType* stvShapeInfo, void* vstM, const sd::LongType* stmShapeInfo, 
    void* vstH, const sd::LongType* sthShapeInfo, const double dLr, const double dBeta1, const double dBeta2, const double dEpsilon, const int nIteration) {
...
void updaterAmsGrad(sd::LaunchContext* context, const NDArray& gradient, const NDArray& initStateV, const NDArray& initStateM, const NDArray& initStateH, 
    ...
    BUILD_SINGLE_SELECTOR(gradient.dataType(), amsGradUpdaterCudaLauncher, (blocksPerGrid, threadsPerBlock, context->getCudaStream(), gradient.specialBuffer(), gradient.specialShapeInfo(),
        ...
        stateH.specialBuffer(), stateH.specialShapeInfo(), dLr, dBeta1, dBeta2, dEpsilon, nIteration), SD_FLOAT_TYPES);
