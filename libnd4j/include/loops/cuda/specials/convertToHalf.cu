...
////////////////////////////////////////////////////////////////////////
    ...
    BUILD_SINGLE_TEMPLATE(template void SD_LIB_HIDDEN convertToHalfGeneric, (dim3 & launchDims, cudaStream_t * stream, void * dx, sd::LongType n, half * dz), SD_COMMON_TYPES);
