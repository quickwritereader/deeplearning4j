...
///////////////////////////////////////////////////////////////////
template <typename T>
SD_KERNEL static void prefixPerBlockCuda(scalar::Ops op,
                                        const void* vx, const sd::LongType* xTadShapeInfo, const sd::LongType* xTadOffsets,
                                              void* vz, const sd::LongType* zTadShapeInfo, const sd::LongType* zTadOffsets,
                                        const sd::LongType numTads, const sd::LongType tadLen,
...
void prefix(sd::LaunchContext * context, scalar::Ops op, const NDArray* x, NDArray* z, const std::vector<int>& dims, bool exclusive, bool reverse) {
    ...
    BUILD_SINGLE_SELECTOR(x->dataType(), prefixPerBlockCudaLauncher, (blocksPerGrid, threadsPerBlock, sharedMem, context->getCudaStream(), op, x->specialBuffer(), packX.platformShapeInfo(), packX.platformOffsets(), z->specialBuffer(), packZ.platformShapeInfo(), packZ.platformOffsets(), numTads, tadLen, exclusive, reverse), SD_NUMERIC_TYPES);
