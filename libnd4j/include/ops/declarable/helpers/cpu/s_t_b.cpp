...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void batchToSpace_(const NDArray& input, NDArray& output, const sd::Unsigned cropBottom, const sd::Unsigned cropTop, const sd::Unsigned cropLeft, const sd::Unsigned cropRight) {
            ...
            for (auto h = start_y; h < stop_y; h += inc_y) {
                for (auto w = start_z; w < stop_z; w += inc_z) {
                    for (sd::Unsigned c = 0; c < iC; ++c) {
                        ...
                        const sd::LongType zOffset = b * zShapeInfo[5] + (h - cropBottom) * zShapeInfo[6] + (w - cropLeft) * zShapeInfo[7] + c * zShapeInfo[8];
...
BUILD_SINGLE_TEMPLATE(template void batchToSpace_, (const NDArray& input, NDArray& output, const sd::Unsigned cropBottom, const sd::Unsigned cropTop, const sd::Unsigned cropLeft, const sd::Unsigned cropRight), SD_COMMON_TYPES);
...
void batchToSpace(sd::LaunchContext* context, const NDArray& input, NDArray& output, const sd::Unsigned cropBottom, const sd::Unsigned cropTop, const sd::Unsigned cropLeft, const sd::Unsigned cropRight, const sd::Unsigned blockSize) {
    ...
    if(input.lengthOf() == output.lengthOf())
        ...
        BUILD_SINGLE_SELECTOR(input.dataType(), batchToSpace_, (inputRearranged1, output, cropBottom, cropTop, cropLeft, cropRight), SD_COMMON_TYPES);
    }
}

//////////////////////////////////////////////////////////////////////////
template <typename T>
static void batchToSpaceND_(const NDArray& input, const NDArray& crop, NDArray& output, const sd::Unsigned numOfSpatialDims) {
...
BUILD_SINGLE_TEMPLATE(template void batchToSpaceND_, (const NDArray& input, const NDArray& crop, NDArray& output, const sd::Unsigned numOfSpatialDims), SD_COMMON_TYPES);
...
void batchToSpaceND(sd::LaunchContext* context, const NDArray& input, const NDArray& blockShape, const NDArray& crop, NDArray& output) {
    ...
    for(sd::Unsigned j = 1; j < rank; ++i, ++j)
    ...
    for(i = 2 * numOfSpatialDims + 1; i < static_cast<sd::Unsigned>(temp.size()); ++i)
        temp[i] = i;
    ...
    if(input.lengthOf() == output.lengthOf()) {
        ...
        BUILD_SINGLE_SELECTOR(input.dataType(), batchToSpaceND_, (inputRearranged1, crop, output, numOfSpatialDims), SD_COMMON_TYPES);
    }
}

//////////////////////////////////////////////////////////////////////////
template <typename T>
static void spaceToBatch_(const NDArray& input, NDArray& output, const sd::Unsigned padBottom, const sd::Unsigned padTop, const sd::Unsigned padLeft, const sd::Unsigned padRight) {
                ...
                for (sd::Unsigned w = 0; w < oW; ++w) {
                    for (sd::Unsigned c = 0; c < iC; ++c) {
                        ...
                        if (h >= padBottom && h < oH - padTop && w >= padLeft && w < oW - padRight) {
                            const sd::LongType xOffset = b * xShapeInfo[5] + (h - padBottom) * xShapeInfo[6] + (w - padLeft) * xShapeInfo[7] + c * xShapeInfo[8];
                            z[zOffset] = x[xOffset];
                        } else
                            z[zOffset] = 0.f;
                    }
...
BUILD_SINGLE_TEMPLATE(template void spaceToBatch_, (const NDArray& input, NDArray& output, const sd::Unsigned padBottom, const sd::Unsigned padTop, const sd::Unsigned padLeft, const sd::Unsigned padRight), SD_COMMON_TYPES);
...
void spaceToBatch(sd::LaunchContext* context, const NDArray& input, NDArray& output, const sd::Unsigned padBottom, const sd::Unsigned padTop, const sd::Unsigned padLeft, const sd::Unsigned padRight, const sd::Unsigned blockSize) {
    ...
    if(input.lengthOf() == output.lengthOf()) {
        ...
        BUILD_SINGLE_SELECTOR(input.dataType(), spaceToBatch_, (input, outputRearranged1, padBottom, padTop, padLeft, padRight), SD_COMMON_TYPES);
...
//////////////////////////////////////////////////////////////////////////
template <typename T>
static void spaceToBatchND_(const NDArray& input, const NDArray& padding, NDArray& output, const sd::Unsigned numOfSpatialDims) {
...
BUILD_SINGLE_TEMPLATE(template void spaceToBatchND_, (const NDArray& input, const NDArray& padding, NDArray& output, const sd::Unsigned numOfSpatialDims), SD_COMMON_TYPES);
...
void spaceToBatchND(sd::LaunchContext* context, const NDArray& input, const NDArray& blockShape, const NDArray& padding, NDArray& output ) {
    ...
    if(input.lengthOf() == output.lengthOf()) {
        ...
        BUILD_SINGLE_SELECTOR(input.dataType(), spaceToBatchND_, (input, padding, outputRearranged1, numOfSpatialDims), SD_COMMON_TYPES);
...
/*
    ...
    sd::Status _spaceToBatch(sd::LaunchContext * context, int internal_block_dims, NDArray *input, NDArray *output, std::vector<sd::LongType> &internal_input_shape, std::vector<sd::LongType> &internal_output_shape, sd::LongType *block_shape, sd::LongType *paddings) {
        ...
        switch (internal_block_dims) {
            ...
            case 4:
                ...
                break;
            default: {
                return Logger::logKernelFailureMsg("SpaceToBatch: Wrong number of internal_block_dims");
            }
        }
