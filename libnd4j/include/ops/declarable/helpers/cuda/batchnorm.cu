...
//////////////////////////////////////////////////////////////////////////
template<typename T>
SD_KERNEL static void batchnormCuda2(const void* vx, const sd::LongType* xShapeInfo,
                                    const void* vMean, const sd::LongType* meanShapeInfo,
                                    const void* vVariance, const sd::LongType* varianceShapeInfo,
                                    const void* vGamma, const sd::LongType* gammaShapeInfo,
                                    const void* vBeta, const sd::LongType* betaShapeInfo,
...
///////////////////////////////////////////////////////////////////
// template<typename T>
// SD_HOST static void batchnormCudaLauncher(const int blocksPerGrid, const int threadsPerBlock, const cudaStream_t *stream,
...
///////////////////////////////////////////////////////////////////
template<typename T>
SD_HOST static void batchnormCudaLauncher2(const int blocksPerGrid, const int threadsPerBlock, const cudaStream_t *stream,
                                            const void* vx, const sd::LongType* xShapeInfo,
                                            const void* vMean, const sd::LongType* meanShapeInfo,
                                            const void* vVariance, const sd::LongType* varianceShapeInfo,
                                            const void* vGamma, const sd::LongType* gammaShapeInfo,
