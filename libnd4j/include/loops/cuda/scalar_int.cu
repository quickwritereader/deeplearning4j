...
template<typename X>
template <typename OpType>
SD_HOST void ScalarIntTransform<X>::intermediateAlongDimension(dim3& launchDims, cudaStream_t *stream,
...
template<typename X>
template<typename OpType>
void SD_HOST ScalarIntTransform<X>::intermediateShaped(dim3& launchDims, cudaStream_t *stream,
