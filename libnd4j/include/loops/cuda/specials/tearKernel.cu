...
////////////////////////////////////////////////////////////////////////
    template<typename T>
    SD_DEVICE void
    tearKernel(void *vx, sd::LongType const* xShapeInfo, sd::Pointer *targets, sd::LongType const* zShapeInfo, sd::LongType const* tadShapeInfo,
...
////////////////////////////////////////////////////////////////////////
    template<typename T>
    SD_KERNEL void
    execTearKernel(void *vx, sd::LongType const* xShapeInfo, sd::Pointer *targets, sd::LongType const* zShapeInfo, sd::LongType const* tadShapeInfo,
                   sd::LongType const* tadOffsets) {
...
////////////////////////////////////////////////////////////////////////
    template<typename T>
    SD_HOST void tearKernelGeneric(dim3 &launchDims, cudaStream_t *stream,
    ...
    BUILD_SINGLE_TEMPLATE(template void SD_LIB_HIDDEN tearKernelGeneric, (dim3 & launchDims, cudaStream_t * stream, void * vx, sd::LongType const* xShapeInfo, sd::Pointer *targets, sd::LongType const* zShapeInfo, sd::LongType const* tadShapeInfo, sd::LongType const* tadOffsets), SD_COMMON_TYPES);
}