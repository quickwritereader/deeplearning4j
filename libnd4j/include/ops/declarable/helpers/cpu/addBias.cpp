    ...
    namespace ops {
        namespace helpers {
            ...
            static typename std::enable_if<std::is_same<X, Y>::value, const X*>::type
                flattened_bias(const Y* b_real, X* b_stack, const size_t b_stack_size, std::unique_ptr<X[]>& b_heap, const sd::LongType num, sd::LongType yStrideC)
            {
            ...
            static void channel_atTheEnd_stride1_C(const sd::LongType*& x_strides, const sd::LongType*& bases, T* x, const T* b, T* z, const bool& inplace, const sd::LongType& start, const sd::LongType& stop, const sd::LongType& inc)
            {
            ...
            template<typename T, size_t constRank >
            static void channel_atTheEnd_generic_C(const sd::LongType* bases, const sd::LongType* x_strides, const sd::LongType* z_strides, const bool& inplaceOp, const bool same_stride, const bool same_order, T* x, const T* b, T* z, sd::LongType start, sd::LongType stop, sd::LongType inc) {
            ...
            */
            template<typename T>
            static void channel_atTheEnd_continous_C(T* x, const T* b, T* z, bool inplaceOp, sd::LongType start, sd::LongType stop, sd::LongType inc) {
            ...
            static void channel_NC_stride1_C(const sd::LongType*& x_strides, const sd::LongType*& bases, T* x, const T2* b, T* z, const bool& inplace, const sd::LongType yStrideC, const sd::LongType& start, const sd::LongType& stop, const sd::LongType& inc)
            {
                size_t loop_count = (stop - start) / inc;
                sd::CoordsState<constRank - 1> cst;
                size_t offset = sd::init_coords<constRank>(cst, start, bases, x_strides);
            ...
            template<typename T, typename T2, size_t constRank >
            static void channel_NC_generic_C(const sd::LongType* bases, const sd::LongType* x_strides, const sd::LongType* z_strides, const bool& inplaceOp, const bool same_stride, const bool same_order, const sd::LongType yStrideC, T* x, const T2* b, T* z, sd::LongType start, sd::LongType stop, sd::LongType inc) {
            ...
            static void channel_NC_continous_numHW_C(sd::LongType rank, const sd::LongType* bases, const sd::LongType* x_strides, T* x, const T2* b, T* z, bool inplaceOp, const sd::LongType yStrideC, sd::LongType start, sd::LongType stop, sd::LongType inc) {
            ...
            static void channel_generic_stride_skip_F(const sd::LongType*& x_strides, const sd::LongType*& bases, T* x, const T2* b, T* z, const bool& inplace, const sd::LongType yStrideC, const sd::LongType& start, const sd::LongType& stop, const sd::LongType& inc)
            {
                // (stop-start) % inc == 0 because  we  handled inside partitioning using the channel size
                size_t loop_count = (stop - start) / inc;
                sd::CoordsState<constRank - 1> cst;
            ...
            static void channel_generic_F(const sd::LongType* bases, const sd::LongType* x_strides, const sd::LongType* z_strides, const bool& inplaceOp, const bool same_stride, const bool same_order, const sd::LongType yStrideC, T* x, const T2* b, T* z, sd::LongType start, sd::LongType stop, sd::LongType inc) {
                //just ensure that passed sameStride is correct,  because when bases are equal orders matters 
                bool sameOrderStride = same_order && same_stride;
            ...
            void addBias(sd::graph::Context& block, const NDArray& input, const NDArray& bias, NDArray& output, const bool isNCHW) {
                ...
                BUILD_DOUBLE_SELECTOR(input.dataType(), bias.dataType(), addBias_, (input, bias, output, isNCHW), SD_FLOAT_TYPES, SD_FLOAT_TYPES);
            }


            BUILD_DOUBLE_TEMPLATE(template void addBias_, (const NDArray& input, const NDArray& bias, NDArray& output, const bool isNCHW), SD_FLOAT_TYPES, SD_FLOAT_TYPES);
        }
    }
}
