...
namespace sd {
    namespace ops {
        namespace helpers {
            ...
            static SD_INLINE void indexInnerReductionRank1(const X* buffer, X& current, Z& argCurrent, const sd::LongType& loopCount)
            {
                argCurrent = 0;
                current = buffer[0];
                LOG_CALLS(0)
            ...
            template<typename X, typename Z, typename ReductionOp>
            static SD_INLINE void indexInnerReductionRank1(const X* buffer, X& current, Z& argCurrent, const sd::LongType& loopCount, const sd::LongType& inner_stride)
            {
                argCurrent = 0;
                current = buffer[0];
                LOG_CALLS(0)
            ...
            static SD_INLINE void indexInnerReductionConstRank(const X* buffer, X& current, Z& argCurrent, const sd::LongType* bases, const sd::LongType* strides, const sd::LongType outerLoopCount, const sd::LongType& innerLoopCount)
            {
            ...
            template<typename X, typename Z, typename ReductionOp, size_t constRank, bool LastIndexFaster = true>
            static SD_INLINE void indexInnerReductionConstRank(const X* buffer, X& current, Z& argCurrent, const sd::LongType* bases, const sd::LongType* strides, const sd::LongType outerLoopCount, const sd::LongType& innerLoopCount, const sd::LongType& inner_stride)
            {
                //skip 1 from the beginning or end depending the Order 
                constexpr size_t updated_index = LastIndexFaster ? 0 : 1;
                constexpr size_t updated_rank = constRank - 1;
            ...
            static SD_INLINE void indexInnerReduction(const int& rank, const X* buffer, X& current, Z& argCurrent, const sd::LongType* bases, const sd::LongType* strides, const sd::LongType& outerLoopStart, const sd::LongType& outerLoopStop, const sd::LongType& innerLoopCount)
            {
                size_t offset = 0;
            ...
            template<typename X, typename Z, typename ReductionOp, bool LastIndexFaster = true>
            static SD_INLINE void indexInnerReduction(const int& rank, const X* buffer, X& current, Z& argCurrent, const sd::LongType* bases, const sd::LongType* strides, const sd::LongType& outerLoopStart, const sd::LongType& outerLoopStop, const sd::LongType& innerLoopCount, const sd::LongType& inner_stride)
            {
                size_t offset = 0;
                sd::LongType outerLoopCount = outerLoopStop - outerLoopStart;
                sd::LongType coords[SD_MAX_RANK] = {};
            ...
            template<typename X, typename Z, typename ReductionOp>
            static SD_INLINE void indexInnerReductionRank1Block4WithMerge(const X* buffer, X& current, Z& argCurrent, const sd::LongType& loopCount)
            {
                argCurrent = 0;
                current = buffer[0];
                LOG_CALLS(0)
            ...
            template<typename X, typename Z, typename ReductionOp>
            static SD_INLINE void indexInnerReductionRank1Block4WithMerge(const X* buffer, X& current, Z& argCurrent, const sd::LongType& loopCount, const sd::LongType& inner_stride)
            {
                argCurrent = 0;
                current = buffer[0];
                LOG_CALLS(0)
            ...
            template<typename X, typename Z, typename ReductionOp>
            static SD_INLINE void indexInnerReductionRank1Block4(const X* buffer, const X* buffer1, const X* buffer2, const X* buffer3, Z* output, Z* output1, Z* output2, Z* output3, const sd::LongType& loopCount)
            {
                LOG_CALLS(0)
                Z argCurrent = 0;
                Z argCurrent1 = 0;
            ...
            template<typename X, typename Z, typename ReductionOp>
            static SD_INLINE void indexInnerReductionRank1Block4(const X* buffer, const X* buffer1, const X* buffer2, const X* buffer3, Z* output, Z* output1, Z* output2, Z* output3, const sd::LongType& loopCount, const sd::LongType& inner_stride)
            {
                LOG_CALLS(0)
                Z argCurrent = 0;
                Z argCurrent1 = 0;
            ...
            template<typename X, typename Z, typename ReductionOp, size_t constRank, bool LastIndexFaster = true>
            static SD_INLINE void indexInnerReductionConstRankBlock4(const X* buffer, const X* buffer1, const X* buffer2, const X* buffer3,
                Z* output, Z* output1, Z* output2, Z* output3, const sd::LongType* bases, const sd::LongType* strides,
                const sd::LongType& outerLoopCount, const sd::LongType& innerLoopCount)
            {
                LOG_CALLS(0)
                //skip 1 from the beginning or end depending the Order 
                constexpr size_t updated_index = LastIndexFaster ? 0 : 1;
            ...
            static SD_INLINE void indexInnerReductionConstRankBlock4(const X* buffer, const X* buffer1, const X* buffer2, const X* buffer3,
                Z* output, Z* output1, Z* output2, Z* output3, const sd::LongType* bases, const sd::LongType* strides,
                const sd::LongType& outerLoopCount, const sd::LongType& innerLoopCount, const sd::LongType& inner_stride)
            {
                LOG_CALLS(0)
                //skip 1 from the beginning or end depending the Order 
                constexpr size_t updated_index = LastIndexFaster ? 0 : 1;
            ...
            template<typename X, typename Z, typename ReductionOp, bool LastIndexFaster = true>
            static void argIndexCase1Scalar(const  int& second_rank,const sd::LongType* inner_bases,const sd::LongType* inner_strides, const  X* bufferX, Z* outputZ)
            {
            ...
            static void argReductionInnerCases(Movement& movement, sd::LongType loopTotal, const int& second_rank,const sd::LongType* inner_bases,const sd::LongType* inner_strides, const X* bufferX, Z* outputZ)
            {
            ...
            static void argIndexCaseNonScalar(const  int& first_rank, const int& output_rank, bool squashed, const  int& second_rank,
                ...
                const sd::LongType*& inner_bases,const sd::LongType* inner_strides, const X* bufferX, Z* outputZ)
            {
