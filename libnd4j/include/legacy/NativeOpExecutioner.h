 ...
 /**
    ...
    */
    ...
    static void execRandom(sd::LaunchContext  *lc,
                           int opNum,
                           sd::Pointer state,
                           void *hZ, const sd::LongType *hZShapeBuffer,
                           void *dZ, const sd::LongType *dZShapeBuffer,
                           void *extraArguments);

    static void execRandom(sd::LaunchContext  *lc,
                           int opNum,
                           sd::Pointer state,
                           const void *hX, const sd::LongType *hXShapeBuffer,
                           const void *dX, const sd::LongType *dXShapeBuffer,
                           void *hZ, const sd::LongType *hZShapeBuffer,
                           void *dZ, const sd::LongType *dZShapeBuffer,
                           void *extraArguments);
    ...
    static void execRandom(sd::LaunchContext  *lc,
                           ...
                           const void *hX, const sd::LongType *hXShapeBuffer,
                           const void *dX, const sd::LongType *dXShapeBuffer,
                           const void *hY, const sd::LongType *hYShapeBuffer,
                           const void *dY, const sd::LongType *dYShapeBuffer,
                           void *hZ, const sd::LongType *hZShapeBuffer,
                           void *dZ, const sd::LongType *dZShapeBuffer,
                           void *extraArguments);
    ...
    static void execSort(void *x, const sd::LongType *xShapeInfo, int *dimension, int dimensionLength, const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets, bool descending) {
        auto xType = sd::ArrayOptions::dataType(xShapeInfo);

        BUILD_SINGLE_SELECTOR(xType, sd::SpecialMethods, ::sortTadGeneric(x, xShapeInfo, dimension, dimensionLength, tadShapeInfo, tadOffsets, descending), SD_COMMON_TYPES);
    }

    inline static void execSortCooIndices(sd::LongType *indices, void *x, sd::LongType length, const sd::LongType *xShapeInfo) {
        auto xType = sd::ArrayOptions::dataType(xShapeInfo);
        int rank = shape::rank(xShapeInfo);

        BUILD_SINGLE_SELECTOR(xType, sd::sparse::SparseUtils, ::sortCooIndicesGeneric(indices, x, length, rank), SD_COMMON_TYPES);
    }

    inline static void execRavelMultiIndex(sd::LongType *indices, sd::LongType *flatIndices, sd::LongType length,  sd::LongType *shapeInfo, int mode) {
        sd::sparse::IndexUtils::ravelMultiIndex(indices, flatIndices, length, shapeInfo, mode);
    }

    inline static void execUnravelIndex(sd::LongType *indices, sd::LongType *flatIndices, sd::LongType length,  sd::LongType *shapeInfo) {
        sd::sparse::IndexUtils::unravelIndex(indices, flatIndices, length, shapeInfo);
    }

    inline static sd::LongType encodeBitmap(void *dx, const sd::LongType *xShapeInfo, sd::LongType N, int *dz, float threshold) {
        auto xType = sd::ArrayOptions::dataType(xShapeInfo);

        BUILD_SINGLE_SELECTOR(xType, return sd::SpecialMethods, ::encodeBitmapGeneric(dx, xShapeInfo, N, dz, threshold), SD_FLOAT_TYPES);
    }
