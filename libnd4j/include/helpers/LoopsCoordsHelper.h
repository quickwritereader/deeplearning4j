...
#define ZIP_OF_ADJUST2(x,index)  ((x).::sd::ZipCoordsState<(index)>::adjust2)
    ...
    SD_INLINE SD_HOST_DEVICE void   index2coords_C(sd::LongType index, const sd::LongType rank, const sd::LongType* bases, sd::LongType* coords) {
    ...
    SD_INLINE SD_HOST_DEVICE void   index2coords_F(sd::LongType index, const sd::LongType rank, const sd::LongType* bases, sd::LongType* coords) {
    ...
    SD_INLINE SD_HOST_DEVICE size_t offset_from_coords(const sd::LongType* strides, const sd::LongType* coords, const  sd::LongType& rank) {
    ...
    SD_INLINE SD_HOST_DEVICE zip_size_t offset_from_coords(const sd::LongType* x_strides, const sd::LongType* z_strides, const sd::LongType* coords, const sd::LongType& rank) {
    ...
    SD_INLINE SD_HOST_DEVICE
        ...
        init_coords(CoordsState<Rank - 1>& cbs, const sd::LongType index, const sd::LongType* bases, const sd::LongType* strides, size_t offset = 0) {
        constexpr size_t Ind = StridesOrderInd<Rank, rankIndex, Last_Index_Faster>();
    ...
    SD_INLINE SD_HOST_DEVICE
        ...
        eq_coords(CoordsState<Rank - 1>& cbs, const sd::LongType* coords) {
    ...
    SD_INLINE SD_HOST_DEVICE
        typename std::enable_if<(Rank - 1 == rankIndex), bool>::type
        eq_zip_coords(ZipCoordsState<Rank - 1>& cbs, const sd::LongType* coords) {
    ...
    SD_INLINE SD_HOST_DEVICE
        typename std::enable_if<(Rank - 1 == rankIndex), zip_size_t>::type
        init_coords(ZipCoordsState<Rank - 1>& cbs, const sd::LongType index, const sd::LongType* bases, const sd::LongType* x_strides, const sd::LongType* z_strides, zip_size_t offset = {}) {
        constexpr size_t Ind = StridesOrderInd<Rank, rankIndex, Last_Index_Faster>();
    ...
    SD_INLINE SD_HOST_DEVICE size_t inc_coords(const sd::LongType* bases, const sd::LongType* strides, sd::LongType* coords, size_t last_offset, const size_t rank, const size_t skip = 0) {
    ...
    template<>
    SD_INLINE SD_HOST_DEVICE size_t inc_coords<false>(const sd::LongType* bases, const sd::LongType* strides, sd::LongType* coords, size_t last_offset, const size_t rank, const size_t skip) {
    ...
    template<bool Last_Index_Faster = true>
    SD_INLINE SD_HOST_DEVICE zip_size_t inc_coords(const sd::LongType* bases, const sd::LongType* x_strides, const  sd::LongType* z_strides, sd::LongType* coords, zip_size_t last_offset, const size_t rank, const size_t skip = 0) {
    ...
    template<>
    SD_INLINE SD_HOST_DEVICE zip_size_t inc_coords<false>(const sd::LongType* bases, const sd::LongType* x_strides, const  sd::LongType* z_strides, sd::LongType* coords, zip_size_t last_offset, const size_t rank, const size_t skip) {
    ...
    template<bool Last_Index_Faster = true>
    SD_INLINE SD_HOST_DEVICE triple_size_t inc_coords(const sd::LongType* bases, const sd::LongType* x_strides, const  sd::LongType* y_strides, const  sd::LongType* z_strides, sd::LongType* coords, triple_size_t last_offset, const size_t rank, const size_t skip = 0) {
    ...
    template<>
    SD_INLINE SD_HOST_DEVICE triple_size_t inc_coords<false>(const sd::LongType* bases, const sd::LongType* x_strides, const  sd::LongType* y_strides, const  sd::LongType* z_strides, sd::LongType* coords, triple_size_t last_offset, const size_t rank, const size_t skip) {
    ...
    SD_INLINE SD_HOST_DEVICE triple_size_t offset_from_coords(const sd::LongType* x_strides, const  sd::LongType* y_strides, const  sd::LongType* z_strides, const sd::LongType* coords, const sd::LongType& rank) {
    ...
    template<bool Last_Index_Faster = true>
    SD_INLINE SD_HOST_DEVICE sd::LongType getLength(const sd::LongType* bases, int rank, int skip, sd::LongType& outSkippedLength)
    {
        if (skip < 0 || skip >= rank) skip = 0;
        sd::LongType total = 1;
        for (int i = 0; i < rank - skip; i++) {
    ...
    template<>
    SD_INLINE SD_HOST_DEVICE sd::LongType getLength<false>(const sd::LongType* bases, int rank, int skip, sd::LongType& outSkippedLength)
    {
        if (skip < 0 || skip >= rank) skip = 0;
        if (skip > 0) {
            outSkippedLength = 1;
...
*/
    ...
    SD_INLINE SD_HOST_DEVICE void rePartition(char order, const std::vector<int>& dimensions, const size_t rank, const sd::LongType* bases, const sd::LongType* strides, sd::LongType(&new_bases)[SD_MAX_RANK], sd::LongType(&new_strides)[SD_MAX_RANK], int& first_begin, int& first_end, int& second_begin, int& second_end, bool first_squash = false, bool second_squash = true) {
    ...
    struct CoordsBaseMovement {
        void init(const sd::LongType* bases, const sd::LongType* strides1, const sd::LongType* strides2, int rank, int start = 0) {
    ...
    struct ZipGenericCoordsRank1Stride1 : CoordsBaseMovement<ZipGenericCoordsRank1Stride1> {
        ...
        void initImpl(const sd::LongType* bases, const sd::LongType* strides1, const sd::LongType* strides2, int rank, int start = 0) {
            offset1 = start;
            offset2 = start;
        }
    ...
    struct ZipGenericCoordsMovementSecondStrideN : CoordsBaseMovement<ZipGenericCoordsMovementSecondStrideN<LastIndexFaster>> {
        ...
        void incrementImpl(int skipRank = 0) {
            offset.first = inc_coords<LastIndexFaster>(_bases, _strides1, (sd::LongType*)&coords, offset.first, _rank, skipRank);
