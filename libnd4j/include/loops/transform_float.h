...
namespace functions {
    ...
    static  SD_DEVICE void transformCuda(const void *dy, const sd::LongType *shapeInfo,
                                          void *params,
                                          void *result, const sd::LongType *resultShapeInfo,
                                          int *allocationPointer, void *reductionPointer,
                                          const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets);

    static  SD_DEVICE void transformCudaLegacy(int opNum,
                                                const void *dy, const sd::LongType *shapeInfo,
                                                void *params,
                                                void *result, const sd::LongType *resultShapeInfo,
                                                int *allocationPointer, void *reductionPointer,
                                                const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets);
    ...
    template<typename OpType>
    static  SD_DEVICE void transformCuda(sd::LongType n,
                                          const void *dy, sd::LongType incy,
                                          void *params,
    ...
    static SD_HOST void executeTransformShaped(dim3 launchDims, cudaStream_t *stream,
                                               int opNum,
                                               const void *x, const sd::LongType *xShape, int xRank,
                                               void *extraParams,
                                               void *z, const sd::LongType *zShape, int zRank,
            ...
            template<typename OpType>
            static SD_LIB_EXPORT void exec(const void *dx, const sd::LongType *xShapeInfo,
                                         void *result, const sd::LongType *resultShapeInfo,
                                         void *extraParams,
                                         uint64_t threadId, uint64_t numThreads);
#endif
