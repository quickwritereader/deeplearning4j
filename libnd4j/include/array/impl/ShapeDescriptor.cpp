...
// #include <ftrace.h>
// #else
// void //----ftrace_region_begin(const char *m){};
// void //----ftrace_region_end(const char *m){};
// #endif
namespace sd {
...
ShapeDescriptor::ShapeDescriptor(const sd::LongType *shapeInfo, bool inheritDtype) {
  //----ftrace_region_begin("ShapeDescriptor#0");
  ...
  //----ftrace_region_end("ShapeDescriptor#0");
  //----ftrace_region_begin("ShapeDescriptor#1");
  _shape_strides.resize(2 * _rank);
  auto _shape = _shape_strides.data();
  auto _strides = _shape_strides.data() + _rank;
  ...
  //----ftrace_region_end("ShapeDescriptor#1");
}
