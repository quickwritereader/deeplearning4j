...
/////////
        ...
        SD_INLINE SD_HOST_DEVICE uint64_t _rotate_left(uint64_t value, uint64_t shift) {
            ...
            sd::LongType val = _rotate_left<sd::LongType>(*reinterpret_cast<sd::LongType *>(&value), *reinterpret_cast<sd::LongType *>(&shift));
...
#ifdef SD_ARM_BUILD
            // TODO: eventually remove this once gcc fixes the bug
            sd::LongType val = _rotate_right<sd::LongType>(*reinterpret_cast<sd::LongType *>(&value), *reinterpret_cast<sd::LongType *>(&shift));
            return *reinterpret_cast<uint64_t *>(&val);
#else
            return value >> shift | value << (64 - shift);
#endif
