...
namespace sd {
    ...
    class SD_LIB_EXPORT ShapeUtils {
        ...
        static std::vector<sd::LongType> evalShapeForTensorDot(const sd::LongType* aShapeInfo, const sd::LongType* bShapeInfo, std::vector<int> axesA, std::vector<int> axesB, std::vector<int>& permutAt, std::vector<int>& permutBt, std::vector<sd::LongType>& shapeAt, std::vector<sd::LongType>& shapeBt);
        static std::vector<sd::LongType> evalShapeForTensorDot(const NDArray* a,   const NDArray* b,   const std::vector<int>& axesA, const std::vector<int>& axesB, std::vector<int>& permutAt, std::vector<int>& permutBt, std::vector<sd::LongType>& shapeAt, std::vector<sd::LongType>& shapeBt);

        // evaluate resulting shape after reduce operation
        static const sd::LongType* evalReduceShapeInfo(const char order, std::vector<int>& dimensions, const NDArray& arr, const sd::DataType dataType, const bool keepDims = false, const bool supportOldShapes = false, sd::memory::Workspace* workspace = nullptr);
        static const sd::LongType* evalReduceShapeInfo(const char order, std::vector<int>& dimensions, const sd::LongType* shapeInfo, const sd::DataType dataType, const bool keepDims = false, const bool supportOldShapes = false, sd::memory::Workspace* workspace = nullptr);
        static const sd::LongType* evalReduceShapeInfo(const char order, std::vector<int>& dimensions, const NDArray& arr, const bool keepDims = false, const bool supportOldShapes = false, sd::memory::Workspace* workspace = nullptr);
        static const sd::LongType* evalReduceShapeInfo(const char order, std::vector<int>& dimensions, const sd::LongType* shapeInfo, const bool keepDims = false, const bool supportOldShapes = false, sd::memory::Workspace* workspace = nullptr);
         ...
         */
        static const sd::LongType* evalReduceShapeInfoEmpty(const char order, std::vector<int>& dimensions, const sd::LongType *shapeInfo, const sd::DataType dataType, const bool keepDims, sd::memory::Workspace* workspace);
        ...
        static const sd::LongType* evalPermShapeInfo(const int* dimensions, const int rank, const NDArray& arr, sd::memory::Workspace* workspace, const bool setContigStrides = false);
        static const sd::LongType* evalPermShapeInfo(const sd::LongType* dimensions, const int rank, const NDArray& arr, sd::memory::Workspace* workspace);

        // evaluate shapeInfo of transposed array
        // if setContigStrides = true, then set contiguous strides in output shapeInfo in accordance with arr order
        static const sd::LongType* evalTranspShapeInfo(const NDArray& arr, sd::memory::Workspace* workspace, const bool setContigStrides = false);
        ...
        static bool evalBroadcastShapeInfo(const NDArray& max, const NDArray& min, const bool evalMinMax, const sd::LongType*& resultShapeInfo, sd::memory::Workspace* workspace);
        static bool evalBroadcastShapeInfo(const sd::LongType *max, const sd::LongType *min, const bool evalMinMax, const sd::LongType*& resultShapeInfo, sd::memory::Workspace* workspace);
        ...
        static bool evalCommonBroadcastShapeInfo(const std::vector<const NDArray*>& arrays, sd::LongType*& resultShapeInfo, memory::Workspace* workspace = nullptr);
        ...
        static const sd::LongType* evalTileShapeInfo(const NDArray& arr, const std::vector<sd::LongType>& reps, sd::memory::Workspace* workspace);
        ...
        static const sd::LongType* matrixProductShape(const sd::LongType* theFirstShape, const sd::LongType* theSecondShape, bool shouldTranspondFirst, bool shouldTranspondSecond, sd::DataType dtype, sd::memory::Workspace* workspace);
        ...
        */
        static std::vector<int> evalPermutFromTo(const std::vector<sd::LongType>& shapeFrom, const std::vector<sd::LongType>& shapeTo);
        ...
        */
        static std::vector<sd::LongType> evalShapeForMatmul(const sd::LongType* xShapeInfo, const sd::LongType* yShapeInfo, const bool transX, const bool transY);
        ...
        */
         ...
         * @return
         */
        static void copyCertainStridesFromShapeInfo(const sd::LongType* inShapeInfo, const int nRank, const int dimsSize, const int* dims, sd::LongType* outStrides);
