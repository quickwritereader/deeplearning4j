...
CUSTOM_OP_IMPL(dynamic_bidirectional_rnn, 7, 4, false, 0, 0) {
    ...
    REQUIRE_TRUE (resultsIn.status() == sd::Status::OK, 0, "dynamic_bidirectional_rnn: there is a problem with reverse on the sequence.");
...
DECLARE_SHAPE_FN(dynamic_bidirectional_rnn) {
    ...
    sd::LongType *hFWShapeInfo(nullptr), *hBWShapeInfo(nullptr), *hFWFinalPrevShapeInfo(nullptr), *hBWFinalPrevShapeInfo(nullptr);
