...
///////////////////////////////////////////////////////////////////////
    template<typename T>
    SD_HOST void
    concatKernelScalarGeneric(dim3 &launchDims, cudaStream_t *stream, int numArrays, sd::Pointer *data, void *vz) {
    ...
    BUILD_SINGLE_TEMPLATE(template void SD_LIB_HIDDEN concatKernelScalarGeneric, (dim3 & launchDims, cudaStream_t * stream, int numArrays, sd::Pointer * data, void * vz), SD_COMMON_TYPES);
}