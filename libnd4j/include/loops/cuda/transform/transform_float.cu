...
SD_KERNEL void transformFloatSimple(const void *x, const sd::LongType *xShapeInfo, int xRank,
                                void *params,
...
namespace functions {
    namespace transform {
        ...
        SD_HOST void TransformFloat<X,Y>::executeTransformShaped(dim3 launchDims, cudaStream_t *stream, int opNum, const void *x, const sd::LongType *xShape, int xRank, void *extraParams, void *z, const sd::LongType *zShape, int zRank, int *allocationPointer, void *reductionPointer,  const sd::LongType *tadShapeInfo, const sd::LongType *tadOffsets) {
        ...
        SD_DEVICE void TransformFloat<X,Z>::transformCuda(const void *vx, const sd::LongType *xShapeInfo,
                                                           void *vparams,
        ...
        template<typename X, typename Y>
        SD_DEVICE void TransformFloat<X,Y>::transformCudaLegacy(
                const int opNum,
        ...
        BUILD_DOUBLE_TEMPLATE(template class SD_LIB_HIDDEN TransformFloat, , SD_COMMON_TYPES, SD_FLOAT_TYPES);
    }
}
