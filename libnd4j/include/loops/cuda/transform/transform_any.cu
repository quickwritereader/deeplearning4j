...
SD_KERNEL void transformAnySimple(
        const void *x, const sd::LongType *xShapeInfo, int xRank,
        void *params,
...
namespace functions {
    namespace transform {
        ...
        BUILD_DOUBLE_TEMPLATE(template class SD_LIB_HIDDEN TransformAny, , SD_COMMON_TYPES, SD_COMMON_TYPES);
    }
}
